...
Cadastrar Cliente: Registo dos dados do cliente (nome e telefone) com validação de campos.
Selecionar Barbeiro: Escolha do profissional responsável pelo atendimento através de menus interativos.
Escolher Serviço: Apresentação da tabela de serviços (Corte, Barba, Sobrancelha, Pezinho) com os respetivos valores.
Gerar Agendamento: Consolidação das informações, associando o cliente, o serviço e o horário num único registo de confirmação.
